        ...
        items: [
            {
                ...
                answer: 'Poggではネットワークビジネス(MLM)、マルチ商法、宗教勧誘、情報商材の販売、強引な営業行為を固く禁じています。該当するユーザーを見つけた場合は、プロフィール画面右上のメニューから「通報」をお願いします。迅速に対応いたします。'
            },
            {
                question: '不適切なメッセージや画像を受け取りました。',
                answer: '性的なメッセージ、暴言、差別的発言、脅迫など、不快なコンテンツを受け取った場合は、すぐに「通報」してください。プロフィール画面右上のメニューから通報でき、運営チームが確認の上、適切に対応いたします。'
            },
            {
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                answer: '現在、パスワードの再設定（リセット）機能は提供していません。お手数ですが、ログインに使用したメールアドレス/パスワードをご確認のうえ、解決しない場合は「お問い合わせ」からご連絡ください。'
            },
            {
