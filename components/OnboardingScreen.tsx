...
const slides: OnboardingSlide[] = [
    {
        ...
        emoji: '🚀',
        title: 'プロジェクトで\n仲間と出会う',
        description: 'ハッカソン、アプリ開発、\n新規事業...一緒に挑戦しよう',
        image: require('../assets/onboarding_projects.png'),
        highlights: ['プロジェクト掲載', 'チームに参加', '大学を超えた出会い'],
    },
    {
        id: '2',
        emoji: '🤝',
        title: '必要な仲間を見つける',
        description: 'エンジニア、デザイナー、\nマーケター...欲しい仲間と繋がる',
        image: require('../assets/onboarding_matching.png'),
        highlights: ['ロールで絞り込み', 'スキルで探す', 'すぐにチャット'],
    },
    {
        id: '3',
        emoji: '💬',
        title: 'チームで\nすぐに動き出す',
        description: 'グループチャットで\nプロジェクトを進めよう',
        image: require('../assets/onboarding_community.png'),
        highlights: ['チーム専用チャット', 'リアルタイム通知', 'スムーズな連携'],
    },
    {
        id: '4',
        emoji: '🎉',
        title: 'さあ、始めよう！',
        description: 'あなたのアイデアを形に\n最高の仲間を見つけよう',
        image: require('../assets/onboarding_create.png'),
        highlights: ['簡単プロジェクト作成', 'メンバー募集', '挑戦を始める'],
    },
];
